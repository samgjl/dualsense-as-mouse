...
class pydualsense:
    ...
    def readInput(self, inReport) -> None:
        ...
        # send all events if needed
        if self.state.trackPadTouch0.isActive: # SAMGJL DID THIS!!!
            self.trackpad_frame_reported(self.state.trackPadTouch0)
        elif not self.state.trackPadTouch0.isActive:
            self.trackpad_off(self.state.trackPadTouch0)
